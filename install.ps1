...
#
# Or download and run:
#   Invoke-WebRequest -Uri https://raw.githubusercontent.com/sudoBrandino/claude-hive/main/install.ps1 -OutFile install.ps1
#   .\install.ps1
...
if (Test-Path $ClaudeSettings) {
    ...
    Copy-Item $ClaudeSettings "$ClaudeSettings.bak"
...
Write-Host ""
Write-Host "Commands:"
Write-Host "  cd $HiveDir; docker compose logs -f   # View logs"
Write-Host "  cd $HiveDir; docker compose down      # Stop"
Write-Host ""
